...
import br.com.framework.implementacao.crud.VariavelConecaoUtil;
/**
 * Responsavel por estabelecer coneção com Hibernate
 * @author vinic
 *
 */
...
public class HibernateUtil implements Serializable {
	...
	public static String JAVA_COMP_ENV_JDBC_DATA_SOURCE = "java:/comp/env/jdbs/datasource";
	...
	public DataSource getDataSourceJndi() throws NamingException{
		InitialContext context = new InitialContext();
		return (DataSource) context.lookup(VariavelConecaoUtil.JAVA_COMP_ENV_JDBC_DATA_SOURCE);
	}
